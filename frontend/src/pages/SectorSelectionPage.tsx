...
const FALLBACK_SECTORS: Sector[] = [
  { id: BigInt(1), name: 'Technology', description: 'Software, AI, cybersecurity, and digital innovation' },
  { id: BigInt(2), name: 'Healthcare', description: 'Medicine, nursing, public health, and wellness' },
  { id: BigInt(3), name: 'Commerce', description: 'Trade, retail, e-commerce, and supply chain' },
  { id: BigInt(4), name: 'Arts', description: 'Design, media, entertainment, and creative fields' },
  { id: BigInt(5), name: 'Business', description: 'Management, entrepreneurship, and strategy' },
  { id: BigInt(6), name: 'Engineering', description: 'Civil, mechanical, electrical, and chemical engineering' },
  { id: BigInt(7), name: 'Finance', description: 'Banking, investment, accounting, and economics' },
  { id: BigInt(8), name: 'Education', description: 'Teaching, training, curriculum design, and research' },
  { id: BigInt(9), name: 'Marketing', description: 'Branding, digital marketing, PR, and advertising' },
  { id: BigInt(10), name: 'Science', description: 'Research, biology, chemistry, and environmental science' },
];
...
export default function SectorSelectionPage() {
  ...
  const sectors = backendSectors && backendSectors.length > 0 ? backendSectors : FALLBACK_SECTORS;
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 animate-fade-in">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Select the broad field that excites you most. This helps us tailor your quiz questions and
        ...
        {isLoading ? (
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            {sectors.map((sector) => {
              const meta = SECTOR_META[sector.name] || { icon: '🌟', color: 'from-purple-500 to-indigo-600' };
        ...
        <div className="flex items-center justify-between">
          <Button
            variant="ghost"
            onClick={() => (window.location.href = '/career-kickstart')}
