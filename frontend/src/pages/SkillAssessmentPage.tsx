...
import { CheckCircle2, Clock, ArrowRight, Award, Sparkles } from 'lucide-react';
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              ...
              <p className="text-muted-foreground max-w-xl">
                Take assessments to discover your strengths, identify areas for growth, and get more
                accurate career recommendations tailored to your abilities.
              </p>
            </div>
            {completedCount > 0 && (
              <div className="bg-white border border-border rounded-xl p-4 text-center shadow-xs shrink-0">
                <p className="font-display font-bold text-2xl text-primary">{completedCount}</p>
                <p className="text-xs text-muted-foreground">of {totalCount} completed</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 mb-8 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Each completed assessment helps our AI better understand your strengths and match you with
              careers where you'll excel. You can take assessments in any order and retake them anytime.
            </p>
          </div>
        </div>
