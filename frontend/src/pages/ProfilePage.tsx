    ...
    <div className="min-h-screen bg-background py-10">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="animate-fade-in">
          <h1 className="font-display font-bold text-3xl text-foreground mb-1">My Profile</h1>
            ...
            <div className="flex items-start gap-5 flex-wrap">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-3 flex-wrap">
                  <div>
                    <h2 className="font-display font-bold text-xl text-foreground">{userProfile.name}</h2>
            ...
            {isEditing && (
              <>
                ...
                <div className="space-y-4">
                  <h3 className="font-semibold text-foreground text-sm">Edit Information</h3>
            ...
            {completedAssessments.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  No assessments completed yet. Take your first assessment to validate your skills.
                </p>
                <Button
                  asChild
                  size="sm"
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {completedAssessments.map((assessment) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-foreground truncate">{assessment.name}</p>
          ...
          <CardContent>
            {userProfile.savedJobs.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  No saved jobs yet. Explore careers and save the ones that interest you.
                </p>
                <Button
                  asChild
                  size="sm"
        ...
        <Card className="border border-border shadow-xs bg-primary/5">
          <CardContent className="p-5">
            ...
            <div className="flex flex-wrap gap-2">
              <Button asChild size="sm" className="gradient-purple text-white shadow-purple hover:shadow-purple-lg transition-all">
