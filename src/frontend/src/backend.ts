...
import type { AssessmentStatus as _AssessmentStatus, JobRole as _JobRole, SkillAssessment as _SkillAssessment, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAvailableRoadmaps(arg0: bigint): Promise<Array<Roadmap>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvailableRoadmaps(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAvailableSectors(): Promise<Array<Sector>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvailableSectors();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRandomQuestions(arg0: bigint): Promise<Array<Question>> {
        if (this.processError) {
            try {
    ...
    async getRecommendedJobRoles(arg0: bigint): Promise<Array<JobRole>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecommendedJobRoles(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitQuizAnswers(arg0: Sector, arg1: Array<bigint>): Promise<UserQuizResult> {
        if (this.processError) {
            try {
    ...
    async updateUserProfile(arg0: string, arg1: string, arg2: string | null): Promise<UserProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUserProfile(arg0, arg1, to_candid_opt_n28(this._uploadFile, this._downloadFile, arg2));
...
function from_candid_AssessmentStatus_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AssessmentStatus): AssessmentStatus {
    return from_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function from_candid_SkillAssessment_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SkillAssessment): SkillAssessment {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    completedAssessments: Array<_SkillAssessment>;
    name: string;
    role: _UserRole;
    email: string;
    savedJobs: Array<_JobRole>;
    profilePicture: [] | [string];
}): {
    completedAssessments: Array<SkillAssessment>;
    name: string;
    ...
    return {
        completedAssessments: from_candid_vec_n13(_uploadFile, _downloadFile, value.completedAssessments),
        name: value.name,
...
function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_AssessmentStatus_n16(_uploadFile, _downloadFile, value.status),
        name: value.name
    };
}
...
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "notStarted" in value ? AssessmentStatus.notStarted : "completed" in value ? AssessmentStatus.completed : "inProgress" in value ? AssessmentStatus.inProgress : value;
}
...
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SkillAssessment>): Array<SkillAssessment> {
    return value.map((x)=>from_candid_SkillAssessment_n14(_uploadFile, _downloadFile, x));
}
function to_candid_AssessmentStatus_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AssessmentStatus): _AssessmentStatus {
    return to_candid_variant_n27(_uploadFile, _downloadFile, value);
}
function to_candid_SkillAssessment_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SkillAssessment): _SkillAssessment {
...
function to_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        completedAssessments: to_candid_vec_n23(_uploadFile, _downloadFile, value.completedAssessments),
        name: value.name,
...
function to_candid_record_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: to_candid_AssessmentStatus_n26(_uploadFile, _downloadFile, value.status),
        name: value.name
    };
}
...
function to_candid_variant_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: AssessmentStatus): {
    notStarted: null;
} | {
    completed: null;
} | {
    ...
    return value == AssessmentStatus.notStarted ? {
        notStarted: null
...
function to_candid_vec_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<SkillAssessment>): Array<_SkillAssessment> {
    return value.map((x)=>to_candid_SkillAssessment_n24(_uploadFile, _downloadFile, x));
}
