...
export const ALL_ASSESSMENT_CATEGORIES: {
  id: string;
  name: string;
  icon: string;
  description: string;
}[] = [
  {
    ...
    name: "Programming",
    icon: "💻",
    description: "Test your coding and software development skills",
  },
  {
    id: "communication",
    name: "Communication",
  ...
  },
  {
    ...
    name: "Data Analysis",
    icon: "📊",
    description: "Evaluate your data interpretation and analytics skills",
  },
  {
    id: "problem-solving",
    name: "Problem Solving",
    icon: "🧩",
    description: "Test your logical reasoning and problem-solving approach",
  },
  {
    id: "leadership",
    name: "Leadership",
    icon: "🏆",
    description: "Assess your leadership and team management capabilities",
  },
  {
    id: "arts",
    name: "Arts & Design",
    icon: "🎨",
    description: "Evaluate your creative and artistic abilities",
  },
  {
    id: "commerce",
    name: "Commerce",
    icon: "📈",
    description: "Test your business and commerce knowledge",
  },
  {
    id: "business",
    name: "Business",
    icon: "💼",
    description: "Assess your entrepreneurial and business acumen",
  },
  {
    id: "healthcare",
    name: "Healthcare",
    icon: "🏥",
    description: "Evaluate your medical and healthcare knowledge",
  },
  {
    id: "engineering",
    name: "Engineering",
    icon: "⚙️",
    description: "Test your engineering and technical skills",
  },
  {
    id: "finance",
    name: "Finance",
    icon: "💰",
    description: "Assess your financial literacy and investment knowledge",
  },
  {
    id: "marketing",
    name: "Marketing",
    icon: "📣",
    description: "Evaluate your marketing and branding skills",
  },
];

export const ASSESSMENT_QUESTIONS: Record<
  string,
...
> = {
  ...
  communication: [
    ...
    {
      text: "Which is a key element of effective communication?",
      answers: [
        "Speaking loudly",
    ...
    {
      text: "What does empathy in communication mean?",
      answers: [
    ...
    {
      text: "What is the purpose of feedback in communication?",
      answers: [
        "To criticize",
  ...
  "data-analysis": [
    ...
    {
      text: "What does mean represent in statistics?",
      answers: [
        "Most frequent value",
        "Middle value",
        "Average value",
    ...
    {
      text: "What tool is commonly used for data analysis?",
      answers: ["Photoshop", "Excel/Python", "Word", "PowerPoint"],
      correct: 1,
    },
  ],
  "problem-solving": [
    ...
    },
    {
      ...
      answers: [
        "A type of storm",
        "Generating multiple ideas freely",
        "Criticizing ideas",
        "Selecting one idea",
      ],
      correct: 1,
    },
    {
      ...
      answers: [
        "Analyzing tree roots",
        "Finding the underlying cause of a problem",
        "Surface-level problem fixing",
        "Ignoring symptoms",
      ],
      correct: 1,
    },
    ...
    {
      text: "What is an iterative approach to problem solving?",
      answers: [
        "Solving once and done",
        "Repeatedly refining solutions",
        "Avoiding problems",
        "Delegating problems",
      ],
      correct: 1,
  ...
  leadership: [
    ...
    {
      text: "What is delegation in leadership?",
      answers: [
    ...
    {
      text: "What does accountability mean in leadership?",
      answers: [
        "Blaming others",
    ...
    {
      text: "What is emotional intelligence in leadership?",
      answers: [
        "Being emotional",
  ...
  arts: [
    ...
    },
    {
      ...
      answers: [
        "Point of view",
        "Technique to show depth and distance",
        "Color shading",
        "Line thickness",
      ],
      correct: 1,
    ...
    {
      text: "What is the golden ratio used for?",
      answers: [
        "Mathematics only",
  ...
  commerce: [
    {
      ...
      answers: [
        "A store name",
        "Economic principle of availability and desire",
        "A type of contract",
        "A business model",
      ],
      correct: 1,
  ...
  business: [
    ...
    },
    {
      ...
      answers: [
        "Shopping research",
        "Gathering information about target market",
        "Financial analysis",
        "Product testing",
      ],
      correct: 1,
  ...
  healthcare: [
    {
      text: "What is the primary role of a doctor?",
      answers: [
        "Administrative work",
    ...
    {
      text: "What is preventive healthcare?",
      answers: [
    ...
    },
    {
      ...
      answers: [
        "A court case",
        "Research study testing medical treatments",
        "A hospital visit",
        "A medical exam",
      ],
      correct: 1,
    },
    {
      ...
      answers: [
        "TV medical shows",
        "Remote healthcare via technology",
  ...
  engineering: [
    {
      text: "What is the engineering design process?",
      answers: [
    ...
    },
    {
      ...
      answers: [
        ...
        "Calculated Architecture Design",
    ...
    {
      text: "What is structural integrity?",
      answers: [
        "Building aesthetics",
        "Ability of structure to withstand loads",
        "Interior design",
        "Material cost",
      ],
      correct: 1,
  ...
  marketing: [
    ...
    },
    {
      ...
      answers: [
        "Company logo only",
        "Visual and emotional representation of a brand",
        "Product quality",
        "Sales strategy",
      ],
      correct: 1,
    ...
    },
    {
      ...
      answers: [
        "A phone call",
        "Prompt encouraging user action",
        "A marketing budget",
        "A product feature",
      ],
      correct: 1,
